...
def test_ReportSendSmokeAll():
    ...
    PDFpath = DataReadMaster.Path + DataReadMaster.GlobalData("test_Smoke_Home_Vendor", "ParentDirectory") + DataReadMaster.GlobalData("test_Smoke_Home_Vendor", "Directory")+ DataReadMaster.GlobalData("test_Smoke_Home_Vendor", "SubDirectory")
    ...
    html = '''
        <html>
            <body>
                <p>Hi Team <br />'''+DataReadMaster.GlobalData('GlobalData', 'EmailIntro_Smoke_Vendor')+'''<br />Below 
    ...
    msg = MIMEMultipart()
    msg['Subject']=DataReadMaster.GlobalData("GlobalData", "EmailSubject_Smoke_Vendor")+' -Test Automation Report- '+date_str
    msg['From'] = email_from
