...
def test_PieChartTestResult():
    TestStatus = []
    path = DataReadMaster.Path + DataReadMaster.GlobalData("test_Smoke_Home_Superintendent", "ParentDirectory") + DataReadMaster.GlobalData("test_Smoke_Home_Superintendent", "Directory")+ DataReadMaster.GlobalData("test_Smoke_Home_Superintendent", "SubDirectory")
