...
def test_ReportSendSmokeAll():
    ...
    SendStatus = []
    AttachmentAdded= []
    PDFpath = DataReadMaster.Path + DataReadMaster.GlobalData("test_Regression_Home_Admin", "ParentDirectory") + DataReadMaster.GlobalData("test_Regression_Home_Admin", "Directory")+ DataReadMaster.GlobalData("test_Regression_Home_Admin", "SubDirectory")
    ...
    html = '''
        <html>
            <body>
                <p>Hi Team <br />'''+DataReadMaster.GlobalData('GlobalData', 'EmailIntro_Regression_Admin')+'''<br />Below 
    ...
    msg = MIMEMultipart()
    msg['Subject']=DataReadMaster.GlobalData("GlobalData", "EmailSubject_Regression_Admin")+' -Test Automation Report- '+date_str
    msg['From'] = email_from
