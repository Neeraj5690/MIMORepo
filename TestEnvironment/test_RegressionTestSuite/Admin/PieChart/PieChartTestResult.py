...
def test_PieChartTestResult():
    TestStatus = []
    path = DataReadMaster.Path + DataReadMaster.GlobalData("test_Regression_Home_Admin", "ParentDirectory") + DataReadMaster.GlobalData("test_Regression_Home_Admin", "Directory")+ DataReadMaster.GlobalData("test_Regression_Home_Admin", "SubDirectory")
